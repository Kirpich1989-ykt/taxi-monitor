...
NEWS_IMPACT = {
    "high": [
        ...
        "перекрыт", "дорога закрыта", "объезд",
        # ЧС и происшествия
        "эвакуация", "чрезвычайная", "взрыв", "пожар",
        "эвакуируют", "оцепление", "спасатели", "мчс",
        # Транспорт специфика
        "не ходят автобусы", "сломался трамвай", "встали трамваи",
        "отменены электрички", "задержка поездов",
    ],
    "medium": [
        # Мероприятия
        "концерт", "матч", "фестиваль", "марафон", "перекроют",
        "футбол", "хоккей", "выставка", "праздник", "салют",
        "митинг", "демонстрация", "парад", "шествие",
        "карнавал", "ярмарка", "форум", "саммит",
        # Погода
        "снегопад", "гололёд", "ливень", "штормовое", "метель",
        "гроза", "туман", "гололедица", "снежный",
        "мороз", "заморозки", "буря", "ураган",
        # Инфраструктура
        "ремонт дороги", "перекрытие улицы", "сужение",
        "временное ограничение", "плановые работы",
        # Туризм и сезон (для Сочи)
        "открытие сезона", "закрытие сезона", "курортный",
        "туристы", "наплыв", "очередь",
    ],
    "low": [
        "пробки", "затруднено движение", "сужение проезжей",
        "задержка", "отмена", "перенос",
        "ожидаются задержки", "рекомендуем объезд",
        "ограничение скорости", "дорожные работы",
    ],
}
